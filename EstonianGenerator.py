...
lines = []
with open('EALD_Wordlist_words_cleaned_20220920.csv', "r") as text_file:
...
g.export_classic_pseudoword_matches_to_csv(pseudoword_matches, "./lextale_pseudowords.csv")
# for w in g.generate_classic(["jõgi"]):
#     print(w["pseudoword"])
#     # print(w)
